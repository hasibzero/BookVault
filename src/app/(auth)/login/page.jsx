  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#f4f7f9] p-4 font-sans">
      ...
      <div className="w-full max-w-[440px] bg-white rounded-2xl shadow-xl p-8 md:p-10">
        ...
        {/* Google Social Login */}
        <button onClick={handleGoogleSignIn} className="cursor-pointer w-full bg-white border border-gray-200 hover:bg-gray-50 text-gray-800 font-bold py-3 rounded-lg text-sm transition-colors duration-200 flex items-center justify-center gap-3 shadow-sm">
          {/* Google G Logo SVG */}
