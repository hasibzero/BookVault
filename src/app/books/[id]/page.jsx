...
addToast({
      ...
      color: "success",
      variant: "flat", // Options: "solid", "bordered", "flat"
    });
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-7 xl:col-span-8 flex flex-col justify-center">
            ...
            <div className="bg-white rounded-xl p-5 md:p-6 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <button onClick={handleBorrow} className="hover:mouse-pointer w-full sm:w-auto bg-[#c85a2f] hover:bg-[#b04a23] text-white px-6 py-3 rounded-md font-bold transition-colors flex items-center justify-center">
