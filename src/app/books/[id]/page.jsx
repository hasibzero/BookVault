  ...
  if (!book) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center font-sans">
        ...
        <Link href="/books" className="text-[#c85a2f] hover:underline">Back to All Books</Link>
      </div>
    );
  }
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="lg:col-span-7 xl:col-span-8 flex flex-col justify-center">
            ...
            {/* Status & Action Box */}
            <div className="bg-[#f5f6f8] rounded-xl p-5 md:p-6 mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
              ...
              {/* Inserted the safe Client component button here! */}
              <BorrowButton availableQuantity={book.available_quantity} />
            </div>
